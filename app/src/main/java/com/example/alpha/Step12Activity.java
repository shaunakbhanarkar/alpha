...
public class Step12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button_step12 = findViewById(R.id.button_step12);

        TextView step12_intro = findViewById(R.id.step12_intro);
        TextView step12_body1 = findViewById(R.id.step12_body1);
        TextView step12_body2 = findViewById(R.id.step12_body2);

        TextView step12_heading1 = findViewById(R.id.step12_heading1);
        TextView step12_heading2 = findViewById(R.id.step12_heading2);



        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step12.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step12 set to white");

            step12_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step12_intro set to black");

            step12_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step12_body1 set to black");

            step12_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step12_body2 set to black");

            step12_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step12_heading1 set to colorPrimary");

            step12_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step12_heading2 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step12.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step12 set to darkBackground");

            step12_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step12_intro set to white");

            step12_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step12_body1 set to white");

            step12_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step12_body2 set to white");

            step12_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step12_heading1 set to darkHighlight");

            step12_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step12_heading2 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step12.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step12 set");
        ...
        final DatabaseReference step12_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 12");


        button_step12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step12 clicked");

                step12_reference.setValue(button_step12.getText());

            }
        });


        step12_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step12_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step12_reference is null");

                    button_step12.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step12_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step12.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step12.setText(getResources().getString(R.string.button_done));
