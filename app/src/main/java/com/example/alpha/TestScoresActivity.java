...
public class TestScoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_add_test_score = findViewById(R.id.button_add_test_score);
        ...
        action_bar_title.setText("Test Scores");
        ...
        if (theme == AppCompatDelegate.MODE_NIGHT_NO){
            ...
            button_add_test_score.setTextColor(getResources().getColor(R.color.white));
            ...
            button_add_test_score.setTextColor(getResources().getColor(R.color.darkBackground));
        ...
        button_add_test_score.setBackgroundTintList(colorStateList);
        ...
        help_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert_dialog_title.setText("Test Scores - Help");
                ...
                textView.setText("This page lets you view and list your Test Scores for your application. You can add a Test Score by mentioning the test name and your corresponding score.\n\nFor example, Test Score might look like:\n\nTest Name: GRE General Test\nScore: (V: 160, Q: 162, AWA: 4.5)\n\nYour Test Scores are one of the many factors that contribute towards strengthening your application.\n\nGood luck!");
        ...
        final DatabaseReference test_scores_reference = databaseReference.child("Data").child(account.getId()).child("Test Scores");


        //initialise elements

        final ListView list_view_test_scores = findViewById(R.id.list_view_test_scores);

        final ArrayList<TestScoresItem> testScoresItemArrayList = new ArrayList<>();  //store items of listview

        final ArrayList<String> keys = new ArrayList<>();   //store keys


        final TestScoresAdapter testScoresAdapter = new TestScoresAdapter(testScoresItemArrayList, getBaseContext());
        list_view_test_scores.setAdapter(testScoresAdapter);



        button_add_test_score.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                TextView alert_dialog_title = new TextView(alert_dialog_layout.getContext());
                alert_dialog_title.setText("Add Test Score");
                alert_dialog_title.setTextSize(22);
                alert_dialog_title.setPadding(40, 20, 20, 20);
                alert_dialog_title.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                alert_dialog_title.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!editText.getText().toString().equals("") && !editText2.getText().toString().equals("") )
                        {
                            ...
                            String test_name = editText.getText().toString();
                            String test_score = editText2.getText().toString();

                            TestScoresItem testScoresItem = new TestScoresItem(test_name, test_score);

                            test_scores_reference.push().setValue(testScoresItem);
        ...
        test_scores_reference.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {

                TestScoresItem testScoresItem = dataSnapshot.getValue(TestScoresItem.class);

                testScoresItemArrayList.add(testScoresItem);
                testScoresAdapter.notifyDataSetChanged();
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                testScoresItemArrayList.set(index,dataSnapshot.getValue(TestScoresItem.class));
            ...
            public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {
                ...
                int index = keys.indexOf(dataSnapshot.getKey());
                testScoresItemArrayList.remove(index);
        ...
        list_view_test_scores.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                TextView alert_dialog_title = new TextView(alert_dialog_layout.getContext());
                alert_dialog_title.setText("Edit Test Score");
                alert_dialog_title.setTextSize(22);
                alert_dialog_title.setPadding(40, 20, 20, 20);
                alert_dialog_title.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                alert_dialog_title.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                ...
                editText.setText(testScoresItemArrayList.get(position).getTest_name());
                editText2.setText(testScoresItemArrayList.get(position).getTest_score());
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!editText.getText().toString().equals("") && !editText2.getText().toString().equals("") )
                        {
                            ...
                            test_scores_reference.child(key).setValue(testScoresItem);
                ...
                button2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String key = keys.get(position);
                        test_scores_reference.child(key).removeValue();
