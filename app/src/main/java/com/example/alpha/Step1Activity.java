...
public class Step1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        action_bar_title.setText("Decide");
        ...
        final Button button_step1 = findViewById(R.id.button_step1);

        TextView step1_intro = findViewById(R.id.step1_intro);
        TextView step1_body1 = findViewById(R.id.step1_body1);
        TextView step1_body2 = findViewById(R.id.step1_body2);
        TextView step1_body3 = findViewById(R.id.step1_body3);

        TextView step1_heading1 = findViewById(R.id.step1_heading1);
        TextView step1_heading2 = findViewById(R.id.step1_heading2);
        TextView step1_heading3 = findViewById(R.id.step1_heading3);


        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step1 set to white");

            step1_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step1_intro set to black");

            step1_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step1_body1 set to black");

            step1_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step1_body2 set to black");

            step1_body3.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step1_body3 set to black");

            step1_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step1_heading1 set to colorPrimary");

            step1_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step1_heading2 set to colorPrimary");

            step1_heading3.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step1_heading3 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step1.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step1 set to darkBackground");

            step1_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step1_intro set to white");

            step1_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step1_body1 set to white");

            step1_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step1_body2 set to white");

            step1_body3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step1_body3 set to white");

            step1_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step1_heading1 set to darkHighlight");

            step1_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step1_heading2 set to darkHighlight");

            step1_heading3.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step1_heading3 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step1.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step1 set");
        ...
        final DatabaseReference step1_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 1");



        button_step1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step1 clicked");

                step1_reference.setValue(button_step1.getText());

            }
        });


        step1_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step1_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step1_reference is null");

                    button_step1.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step1_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step1.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step1.setText(getResources().getString(R.string.button_done));
