...
public class Step8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        action_bar_title.setText("Resume");
        ...
        final Button button_step8 = findViewById(R.id.button_step8);

        TextView step8_intro = findViewById(R.id.step8_intro);
        TextView step8_body1 = findViewById(R.id.step8_body1);
        TextView step8_body2 = findViewById(R.id.step8_body2);

        TextView step8_heading1 = findViewById(R.id.step8_heading1);
        TextView step8_heading2 = findViewById(R.id.step8_heading2);


        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step8.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step8 set to white");

            step8_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step8_intro set to black");

            step8_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step8_body1 set to black");

            step8_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step8_body2 set to black");

            step8_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step8_heading1 set to colorPrimary");

            step8_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step8_heading2 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step8.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step8 set to darkBackground");

            step8_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step8_intro set to white");

            step8_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step8_body1 set to white");

            step8_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step8_body2 set to white");

            step8_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step8_heading1 set to darkHighlight");

            step8_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step8_heading2 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step8.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step8 set");
        ...
        final DatabaseReference step8_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 8");


        button_step8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step8 clicked");

                step8_reference.setValue(button_step8.getText());
        ...
        step8_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step8_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step8_reference is null");

                    button_step8.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step8_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step8.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step8.setText(getResources().getString(R.string.button_done));
