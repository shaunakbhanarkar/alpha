...
public class Step6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button_step6 = findViewById(R.id.button_step6);

        TextView step6_intro = findViewById(R.id.step6_intro);
        TextView step6_body1 = findViewById(R.id.step6_body1);
        TextView step6_body2 = findViewById(R.id.step6_body2);
        TextView step6_body3 = findViewById(R.id.step6_body3);
        TextView step6_body4 = findViewById(R.id.step6_body4);

        TextView step6_heading1 = findViewById(R.id.step6_heading1);
        TextView step6_heading2 = findViewById(R.id.step6_heading2);
        TextView step6_heading3 = findViewById(R.id.step6_heading3);
        TextView step6_heading4 = findViewById(R.id.step6_heading4);


        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step6.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step6 set to white");

            step6_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step6_intro set to black");

            step6_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step6_body1 set to black");

            step6_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step6_body2 set to black");

            step6_body3.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step6_body3 set to black");

            step6_body4.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step6_body4 set to black");

            step6_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step6_heading1 set to colorPrimary");

            step6_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step6_heading2 set to colorPrimary");

            step6_heading3.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step6_heading3 set to colorPrimary");

            step6_heading4.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step6_heading4 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step6.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step6 set to darkBackground");

            step6_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step6_intro set to white");

            step6_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step6_body1 set to white");

            step6_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step6_body2 set to white");

            step6_body3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step6_body3 set to white");

            step6_body4.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step6_body4 set to white");

            step6_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step6_heading1 set to darkHighlight");

            step6_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step6_heading2 set to darkHighlight");

            step6_heading3.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step6_heading3 set to darkHighlight");

            step6_heading4.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step6_heading4 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step6.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step6 set");
        ...
        final DatabaseReference step6_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 6");


        button_step6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step6 clicked");

                step6_reference.setValue(button_step6.getText());
        ...
        step6_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step6_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step6_reference is null");

                    button_step6.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step6_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step6.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step6.setText(getResources().getString(R.string.button_done));
