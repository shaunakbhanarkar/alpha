...
public class Step4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        action_bar_title.setText("Tests");
        ...
        final Button button_step4 = findViewById(R.id.button_step4);

        TextView step4_intro = findViewById(R.id.step4_intro);
        TextView step4_body1 = findViewById(R.id.step4_body1);
        TextView step4_body2 = findViewById(R.id.step4_body2);
        TextView step4_body3 = findViewById(R.id.step4_body3);
        TextView step4_body4 = findViewById(R.id.step4_body4);

        TextView step4_heading1 = findViewById(R.id.step4_heading1);
        TextView step4_heading2 = findViewById(R.id.step4_heading2);
        TextView step4_heading3 = findViewById(R.id.step4_heading3);
        TextView step4_heading4 = findViewById(R.id.step4_heading4);


        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step4.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step4 set to white");

            step4_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step4_intro set to black");

            step4_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step4_body1 set to black");

            step4_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step4_body2 set to black");

            step4_body3.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step4_body3 set to black");

            step4_body4.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step4_body4 set to black");

            step4_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step4_heading1 set to colorPrimary");

            step4_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step4_heading2 set to colorPrimary");

            step4_heading3.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step4_heading3 set to colorPrimary");

            step4_heading4.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step4_heading4 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step4.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step4 set to darkBackground");

            step4_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step4_intro set to white");

            step4_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step4_body1 set to white");

            step4_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step4_body2 set to white");

            step4_body3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step4_body3 set to white");

            step4_body4.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step4_body4 set to white");

            step4_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step4_heading1 set to darkHighlight");

            step4_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step4_heading2 set to darkHighlight");

            step4_heading3.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step4_heading3 set to darkHighlight");

            step4_heading4.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step4_heading4 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step4.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step4 set");
        ...
        final DatabaseReference step4_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 4");



        button_step4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step4 clicked");

                step4_reference.setValue(button_step4.getText());

            }
        });


        step4_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step4_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step4_reference is null");

                    button_step4.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step4_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step4.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step4.setText(getResources().getString(R.string.button_done));
