...
public class Step3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button_step3 = findViewById(R.id.button_step3);

        TextView step3_intro = findViewById(R.id.step3_intro);
        TextView step3_body1 = findViewById(R.id.step3_body1);
        TextView step3_body2 = findViewById(R.id.step3_body2);
        TextView step3_body3 = findViewById(R.id.step3_body3);
        TextView step3_body4 = findViewById(R.id.step3_body4);

        TextView step3_heading1 = findViewById(R.id.step3_heading1);
        TextView step3_heading2 = findViewById(R.id.step3_heading2);
        TextView step3_heading3 = findViewById(R.id.step3_heading3);
        TextView step3_heading4 = findViewById(R.id.step3_heading4);


        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step3 set to white");

            step3_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step3_intro set to black");

            step3_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step3_body1 set to black");

            step3_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step3_body2 set to black");

            step3_body3.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step3_body3 set to black");

            step3_body4.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step3_body4 set to black");

            step3_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step3_heading1 set to colorPrimary");

            step3_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step3_heading2 set to colorPrimary");

            step3_heading3.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step3_heading3 set to colorPrimary");

            step3_heading4.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step3_heading4 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step3.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step3 set to darkBackground");

            step3_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step3_intro set to white");

            step3_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step3_body1 set to white");

            step3_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step3_body2 set to white");

            step3_body3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step3_body3 set to white");

            step3_body4.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step3_body4 set to white");

            step3_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step3_heading1 set to darkHighlight");

            step3_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step3_heading2 set to darkHighlight");

            step3_heading3.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step3_heading3 set to darkHighlight");

            step3_heading4.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step3_heading4 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step3.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step3 set");
        ...
        final DatabaseReference step3_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 3");



        button_step3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step3 clicked");

                step3_reference.setValue(button_step3.getText());

            }
        });


        step3_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step3_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step3_reference is null");

                    button_step3.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step3_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step3.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step3.setText(getResources().getString(R.string.button_done));
