...
public class Step9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        action_bar_title.setText("Statement of Purpose");
        ...
        final Button button_step9 = findViewById(R.id.button_step9);

        TextView step9_intro = findViewById(R.id.step9_intro);
        TextView step9_body1 = findViewById(R.id.step9_body1);
        TextView step9_body2 = findViewById(R.id.step9_body2);

        TextView step9_heading1 = findViewById(R.id.step9_heading1);
        TextView step9_heading2 = findViewById(R.id.step9_heading2);

        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step9.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step9 set to white");

            step9_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step9_intro set to black");

            step9_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step9_body1 set to black");

            step9_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step9_body2 set to black");

            step9_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step9_heading1 set to colorPrimary");

            step9_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step9_heading2 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step9.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step9 set to darkBackground");

            step9_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step9_intro set to white");

            step9_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step9_body1 set to white");

            step9_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step9_body2 set to white");

            step9_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step9_heading1 set to darkHighlight");

            step9_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step9_heading2 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step9.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step9 set");
        ...
        final DatabaseReference step9_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 9");


        button_step9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step9 clicked");

                step9_reference.setValue(button_step9.getText());
        ...
        step9_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step9_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step9_reference is null");

                    button_step9.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step9_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step9.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step9.setText(getResources().getString(R.string.button_done));
