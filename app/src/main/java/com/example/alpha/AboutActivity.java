...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text_view_app_details = findViewById(R.id.text_view_app_details);
        TextView text_view_copyright = findViewById(R.id.text_view_copyright);
        ...
        text_view_app_version.setText("Version " + version);
        ...
        help_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert_dialog_title.setText("About - Help");
                ...
                textView.setText("This page shows you the basic information about this application.");
