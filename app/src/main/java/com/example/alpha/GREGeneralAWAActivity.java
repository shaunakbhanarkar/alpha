...
public class GREGeneralAWAActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g_r_e_general_a_w_a);
        ...
        action_bar_title.setText("AWA-Measure");
        ...
        //initialise elements
        TextView gre_general_awa_issue_title = findViewById(R.id.gre_general_awa_issue_title);
        TextView gre_general_awa_argument_title = findViewById(R.id.gre_general_awa_argument_title);

        TextView gre_general_awa_details = findViewById(R.id.gre_general_awa_details);
        TextView gre_general_awa_issue_details = findViewById(R.id.gre_general_awa_issue_details);
        TextView gre_general_awa_argument_details = findViewById(R.id.gre_general_awa_argument_details);
        ...
        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            gre_general_awa_issue_title.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of gre_general_awa_issue_title set to colorPrimary");

            gre_general_awa_argument_title.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of gre_general_awa_argument_title set to colorPrimary");

            gre_general_awa_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_awa_details set to black");

            gre_general_awa_issue_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_awa_issue_details set to black");

            gre_general_awa_argument_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_awa_argument_details set to black");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            gre_general_awa_issue_title.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of gre_general_awa_issue_title set to darkHighlight");

            gre_general_awa_argument_title.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of gre_general_awa_argument_title set to darkHighlight");

            gre_general_awa_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_awa_details set to white");

            gre_general_awa_issue_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_awa_issue_details set to white");

            gre_general_awa_argument_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_awa_argument_details set to white");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
