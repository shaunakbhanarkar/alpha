...
public class GREGeneralVerbalActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g_r_e_general_verbal);
        ...
        action_bar_title.setText("V-Measure");
        ...
        //initialise elements
        TextView gre_general_verbal_text_completion_title = findViewById(R.id.gre_general_verbal_text_completion_title);
        TextView gre_general_verbal_reading_comprehension_title = findViewById(R.id.gre_general_verbal_reading_comprehension_title);
        TextView gre_general_verbal_sentence_equivalence_title = findViewById(R.id.gre_general_verbal_sentence_equivalence_title);

        TextView gre_general_verbal_details = findViewById(R.id.gre_general_verbal_details);
        TextView gre_general_verbal_text_completion_details = findViewById(R.id.gre_general_verbal_text_completion_details);
        TextView gre_general_verbal_reading_comprehension_details = findViewById(R.id.gre_general_verbal_reading_comprehension_details);
        TextView gre_general_verbal_sentence_equivalence_details = findViewById(R.id.gre_general_verbal_sentence_equivalence_details);
        ...
        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            gre_general_verbal_text_completion_title.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of gre_general_verbal_text_completion_title set to colorPrimary");

            gre_general_verbal_reading_comprehension_title.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of gre_general_verbal_reading_comprehension_title set to colorPrimary");

            gre_general_verbal_sentence_equivalence_title.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of gre_general_verbal_sentence_equivalence_title set to colorPrimary");

            gre_general_verbal_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_verbal_details set to black");

            gre_general_verbal_text_completion_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_verbal_text_completion_details set to black");

            gre_general_verbal_reading_comprehension_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_verbal_reading_comprehension_details set to black");

            gre_general_verbal_sentence_equivalence_details.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of gre_general_verbal_sentence_equivalence_details set to black");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            gre_general_verbal_text_completion_title.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of gre_general_verbal_text_completion_title set to darkHighlight");

            gre_general_verbal_reading_comprehension_title.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of gre_general_verbal_reading_comprehension_title set to darkHighlight");

            gre_general_verbal_sentence_equivalence_title.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of gre_general_verbal_sentence_equivalence_title set to darkHighlight");

            gre_general_verbal_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_verbal_details set to white");

            gre_general_verbal_text_completion_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_verbal_text_completion_details set to white");

            gre_general_verbal_reading_comprehension_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_verbal_reading_comprehension_details set to white");

            gre_general_verbal_sentence_equivalence_details.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of gre_general_verbal_sentence_equivalence_details set to white");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
