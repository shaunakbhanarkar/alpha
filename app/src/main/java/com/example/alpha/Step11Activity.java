...
public class Step11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button_step11 = findViewById(R.id.button_step11);

        TextView step11_intro = findViewById(R.id.step11_intro);
        TextView step11_body1 = findViewById(R.id.step11_body1);
        TextView step11_body2 = findViewById(R.id.step11_body2);
        TextView step11_body3 = findViewById(R.id.step11_body3);

        TextView step11_heading1 = findViewById(R.id.step11_heading1);
        TextView step11_heading2 = findViewById(R.id.step11_heading2);
        TextView step11_heading3 = findViewById(R.id.step11_heading3);



        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step11.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step11 set to white");

            step11_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step11_intro set to black");

            step11_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step11_body1 set to black");

            step11_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step11_body2 set to black");

            step11_body3.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step11_body3 set to black");

            step11_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step11_heading1 set to colorPrimary");

            step11_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step11_heading2 set to colorPrimary");

            step11_heading3.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step11_heading3 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step11.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step11 set to darkBackground");

            step11_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step11_intro set to white");

            step11_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step11_body1 set to white");

            step11_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step11_body2 set to white");

            step11_body3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step11_body3 set to white");

            step11_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step11_heading1 set to darkHighlight");

            step11_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step11_heading2 set to darkHighlight");

            step11_heading3.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step11_heading3 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step11.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step11 set");
        ...
        final DatabaseReference step11_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 11");


        button_step11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step11 clicked");

                step11_reference.setValue(button_step11.getText());

            }
        });


        step11_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step11_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step11_reference is null");

                    button_step11.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step11_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step11.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step11.setText(getResources().getString(R.string.button_done));
