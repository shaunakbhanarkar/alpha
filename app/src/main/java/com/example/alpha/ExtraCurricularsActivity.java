...
public class ExtraCurricularsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_add_extra_curricular = findViewById(R.id.button_add_extra_curricular);
        ...
        action_bar_title.setText("Extra Curriculars");
        ...
        if (theme == AppCompatDelegate.MODE_NIGHT_NO){
            ...
            button_add_extra_curricular.setTextColor(getResources().getColor(R.color.white));
            ...
            button_add_extra_curricular.setTextColor(getResources().getColor(R.color.darkBackground));
        ...
        button_add_extra_curricular.setBackgroundTintList(colorStateList);
        ...
        final DatabaseReference extra_curriculars_reference = databaseReference.child("Data").child(account.getId()).child("Extra Curriculars");


        //initialise elements

        final ListView list_view_extra_curriculars = findViewById(R.id.list_view_extra_curriculars);

        final ArrayList<ExtraCurricularsItem> extraCurricularsItemArrayList = new ArrayList<>();  //store items of listview

        final ArrayList<String> keys = new ArrayList<>();   //store keys


        final ExtraCurricularsAdapter extraCurricularsAdapter = new ExtraCurricularsAdapter(extraCurricularsItemArrayList, getBaseContext());
        list_view_extra_curriculars.setAdapter(extraCurricularsAdapter);


        button_add_extra_curricular.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                TextView alert_dialog_title = new TextView(alert_dialog_layout.getContext());
                alert_dialog_title.setText("Add Extra Curricular");
                alert_dialog_title.setTextSize(22);
                alert_dialog_title.setPadding(40, 20, 20, 20);
                alert_dialog_title.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                alert_dialog_title.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!editText.getText().toString().equals("") && !editText2.getText().toString().equals("") )
                        {
                            ...
                            ExtraCurricularsItem extraCurricularsItem = new ExtraCurricularsItem(title, description);

                            extra_curriculars_reference.push().setValue(extraCurricularsItem);
        ...
        extra_curriculars_reference.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {

                ExtraCurricularsItem extraCurricularsItem = dataSnapshot.getValue(ExtraCurricularsItem.class);

                extraCurricularsItemArrayList.add(extraCurricularsItem);
                extraCurricularsAdapter.notifyDataSetChanged();
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                extraCurricularsItemArrayList.set(index,dataSnapshot.getValue(ExtraCurricularsItem.class));
            ...
            public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {
                ...
                int index = keys.indexOf(dataSnapshot.getKey());
                extraCurricularsItemArrayList.remove(index);
        ...
        list_view_extra_curriculars.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                TextView alert_dialog_title = new TextView(alert_dialog_layout.getContext());
                alert_dialog_title.setText("Edit Extra Curricular");
                alert_dialog_title.setTextSize(22);
                alert_dialog_title.setPadding(40, 20, 20, 20);
                alert_dialog_title.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                alert_dialog_title.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                ...
                editText.setText(extraCurricularsItemArrayList.get(position).getTitle());
                editText2.setText(extraCurricularsItemArrayList.get(position).getDescription());
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!editText.getText().toString().equals("") && !editText2.getText().toString().equals("") )
                        {
                            ...
                            extra_curriculars_reference.child(key).setValue(extraCurricularsItem);
                ...
                button2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String key = keys.get(position);
                        extra_curriculars_reference.child(key).removeValue();
