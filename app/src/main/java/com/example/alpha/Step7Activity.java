...
public class Step7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button_step7 = findViewById(R.id.button_step7);

        TextView step7_intro = findViewById(R.id.step7_intro);
        TextView step7_body1 = findViewById(R.id.step7_body1);
        TextView step7_body2 = findViewById(R.id.step7_body2);
        TextView step7_body3 = findViewById(R.id.step7_body3);

        TextView step7_heading1 = findViewById(R.id.step7_heading1);
        TextView step7_heading2 = findViewById(R.id.step7_heading2);
        TextView step7_heading3 = findViewById(R.id.step7_heading3);



        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step7.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step7 set to white");

            step7_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step7_intro set to black");

            step7_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step7_body1 set to black");

            step7_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step7_body2 set to black");

            step7_body3.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step7_body3 set to black");

            step7_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step7_heading1 set to colorPrimary");

            step7_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step7_heading2 set to colorPrimary");

            step7_heading3.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step7_heading3 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step7.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step7 set to darkBackground");

            step7_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step7_intro set to white");

            step7_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step7_body1 set to white");

            step7_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step7_body2 set to white");

            step7_body3.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step7_body3 set to white");

            step7_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step7_heading1 set to darkHighlight");

            step7_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step7_heading2 set to darkHighlight");

            step7_heading3.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step7_heading3 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step7.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step7 set");
        ...
        final DatabaseReference step7_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 7");


        button_step7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step7 clicked");

                step7_reference.setValue(button_step7.getText());

            }
        });


        step7_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step7_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step7_reference is null");

                    button_step7.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step7_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step7.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step7.setText(getResources().getString(R.string.button_done));
