...
public class Step5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button_step5 = findViewById(R.id.button_step5);

        TextView step5_intro = findViewById(R.id.step5_intro);
        TextView step5_body1 = findViewById(R.id.step5_body1);
        TextView step5_body2 = findViewById(R.id.step5_body2);

        TextView step5_heading1 = findViewById(R.id.step5_heading1);
        TextView step5_heading2 = findViewById(R.id.step5_heading2);


        if (theme == AppCompatDelegate.MODE_NIGHT_NO)
        {
            button_step5.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(), "text color of button_step5 set to white");

            step5_intro.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step5_intro set to black");

            step5_body1.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step5_body1 set to black");

            step5_body2.setTextColor(getResources().getColor(R.color.black));
            Log.d(this.toString(),"text color of step5_body2 set to black");

            step5_heading1.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step5_heading1 set to colorPrimary");

            step5_heading2.setTextColor(getResources().getColor(R.color.colorPrimary));
            Log.d(this.toString(),"text color of step5_heading2 set to colorPrimary");
        }
        else if (theme == AppCompatDelegate.MODE_NIGHT_YES)
        {
            button_step5.setTextColor(getResources().getColor(R.color.darkBackground));
            Log.d(this.toString(), "text color of button_step5 set to darkBackground");

            step5_intro.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step5_intro set to white");

            step5_body1.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step5_body1 set to white");

            step5_body2.setTextColor(getResources().getColor(R.color.white));
            Log.d(this.toString(),"text color of step5_body2 set to white");

            step5_heading1.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step5_heading1 set to darkHighlight");

            step5_heading2.setTextColor(getResources().getColor(R.color.darkHighlight));
            Log.d(this.toString(),"text color of step5_heading2 set to darkHighlight");
        }
        else
        {
            PowerManager powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        ...
        button_step5.setBackgroundTintList(colorStateList);
        Log.d(this.toString(), "background color of button_step5 set");
        ...
        final DatabaseReference step5_reference = databaseReference.child("Data").child(account.getId()).child("Steps").child("Step 5");



        button_step5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(this.toString(),"button_step5 clicked");

                step5_reference.setValue(button_step5.getText());

            }
        });


        step5_reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                Log.d(this.toString(),"data at step5_reference changed");

                String value = dataSnapshot.getValue(String.class);

                if (value == null){
                    Log.e(this.toString(), "data at step5_reference is null");

                    button_step5.setText(getResources().getString(R.string.button_done));
                }

                else
                {

                    Log.d(this.toString(),"data at step5_reference is - "+value);

                    if (value.equals(getResources().getString(R.string.button_done)))
                    {
                        button_step5.setText(getResources().getString(R.string.button_pending));
                    }
                    else
                    {
                        button_step5.setText(getResources().getString(R.string.button_done));
